...
//
bool add_enum_to_lua(luabridge::lua_State* L, const char* tname, ...)
{
...
// }
//
bool check_enum_type(luabridge::lua_State* L, const char* tname, int index)
{
...
// }
//
int get_enum_value(luabridge::lua_State* L, int index)
{
